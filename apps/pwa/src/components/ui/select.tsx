...
/**
 * Base UI renders the *raw value* in a closed trigger unless it is given an
 * `items` map to resolve labels from. Rather than make every call site pass
 * one, we derive it by walking the JSX children for <SelectItem> elements —
 * they exist as React elements even while the popup is unmounted.
 */
