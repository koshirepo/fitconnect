 ...
 * - Relative endpoints declared in this file: POST /:tenantId/members, GET /:tenantId/members, GET /:tenantId/members/birthdays, GET /:tenantId/members/referrals, GET /:tenantId/members/:membershipId, GET /:tenantId/members/:membershipId/coverage, GET /:tenantId/me, PATCH /:tenantId/me, PATCH /:tenantId/members/:membershipId, PATCH /:tenantId/members/:membershipId/role, POST /:tenantId/members/report, PATCH /:tenantId/members/:membershipId/status, DELETE /:tenantId/members/:membershipId, POST /:tenantId/members/:membershipId/reset-password.
...
// The gaps in somebody's membership. Before `/:membershipId`, for the same
// reason birthdays is: the more specific path has to match first.
memberRoutes.get(
  "/:tenantId/members/:membershipId/coverage",
  authenticate,
  requireTenantPermissions(Permission.MEMBERS_READ_DETAIL),
  memberController.getMembershipCoverage,
);
